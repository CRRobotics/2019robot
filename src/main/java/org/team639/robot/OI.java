...
public class OI {
    ...
    public static void mapButtons() {
        controller.mapButton(XBoxController.Buttons.A, new ThreadedDriveCommand(new ApproachVisionTarget(), Robot.drivetrain), JoystickManager.MappingType.WhenPressed);
    }
}
